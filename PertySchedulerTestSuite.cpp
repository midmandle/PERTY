...
CxxTest::StaticSuiteDescription suiteDescription_PertySchedulerTestSuite( "PertySchedulerTestSuite.h", 6, "PertySchedulerTestSuite", suite_PertySchedulerTestSuite, Tests_PertySchedulerTestSuite );

static class TestDescription_suite_PertySchedulerTestSuite_test_newScheduler : public CxxTest::RealTestDescription {
public:
 TestDescription_suite_PertySchedulerTestSuite_test_newScheduler() : CxxTest::RealTestDescription( Tests_PertySchedulerTestSuite, suiteDescription_PertySchedulerTestSuite, 23, "test_newScheduler" ) {}
...
public:
 TestDescription_suite_PertySchedulerTestSuite_test_destroyScheduler() : CxxTest::RealTestDescription( Tests_PertySchedulerTestSuite, suiteDescription_PertySchedulerTestSuite, 33, "test_destroyScheduler" ) {}
...
public:
 TestDescription_suite_PertySchedulerTestSuite_test_sortScheduledTasksByPriorityHighest() : CxxTest::RealTestDescription( Tests_PertySchedulerTestSuite, suiteDescription_PertySchedulerTestSuite, 42, "test_sortScheduledTasksByPriorityHighest" ) {}
